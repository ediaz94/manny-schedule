...
window.DATA = (function () {
  ...
  const phases = [
    { slug: "foundation", name: "Phase 1: Foundation", start: "2026-06-08", end: "2026-07-31",
      ...
      fintech: "Full 5.5 hr/week minimum. Heavy on Tue/Thu mornings.",
    ...
    { slug: "build", name: "Phase 2: Build", start: "2026-08-01", end: "2026-09-15",
      ...
      fintech: "Hit major milestones in Wharton or CFI by end of August.",
    ...
    { slug: "refine", name: "Phase 3: Refine", start: "2026-09-16", end: "2026-10-22",
      ...
      fintech: "May pull back to 4 hr/week if wedding load is heavy. Don't quit it, but don't grind it.",
  ...
  const days = [
    { dow: 1, name: "Monday — Lower Strength", workoutType: "lower-strength", weighIn: false, blocks: [
      { s: "05:15", e: "05:30", type: "wake", title: "Wake & Hydrate", desc: "Water with electrolytes before coffee. Quick scripture or rosary decade. No phone yet." },
      { s: "05:30", e: "05:50", type: "meal", title: "Light Breakfast", desc: "Greek yogurt + berries + nuts, or 2 eggs + 1 slice whole-grain toast. Coffee.", meal: "breakfast" },
      { s: "05:50", e: "06:00", type: "prayer", title: "Morning Prayer with Nicole", desc: "10 minutes together: short scripture, Our Father, intentions for the day.", prayer: "morning" },
      { s: "06:00", e: "07:15", type: "fintech", title: "Fintech Study (Light)", desc: "Review last week's work, plan the week's modules." },
      ...
      { s: "20:30", e: "21:15", type: "flex", title: "Flex Block", desc: "Finamigo client work, fintech reading, light home improvement, options review, or rest." },
    ...
    { dow: 2, name: "Tuesday — Upper Push + Core", workoutType: "upper-push", weighIn: false, blocks: [
      { s: "05:15", e: "05:30", type: "wake", title: "Wake & Hydrate", desc: "Water with electrolytes. Scripture or rosary decade." },
      { s: "05:30", e: "05:50", type: "meal", title: "Light Breakfast", desc: "Greek yogurt + berries + nuts, or eggs + toast.", meal: "breakfast" },
      { s: "05:50", e: "06:00", type: "prayer", title: "Morning Prayer with Nicole", desc: "10 minutes together.", prayer: "morning" },
      { s: "06:00", e: "07:15", type: "fintech", title: "Fintech Heavy Block", desc: "75 min focused: SQL or Power BI hands-on." },
      ...
      { s: "20:30", e: "21:15", type: "flex", title: "Flex Block", desc: "Choose: Finamigo, fintech, hobby, or rest." },
    ...
    { dow: 3, name: "Wednesday — Active Recovery", workoutType: "active-recovery", weighIn: false, blocks: [
      { s: "05:15", e: "05:30", type: "wake", title: "Wake & Hydrate", desc: "Water with electrolytes." },
      { s: "05:30", e: "05:50", type: "meal", title: "Light Breakfast", desc: "Greek yogurt or eggs + toast.", meal: "breakfast" },
      { s: "05:50", e: "06:00", type: "prayer", title: "Morning Prayer with Nicole", desc: "10 minutes.", prayer: "morning" },
      { s: "06:00", e: "07:15", type: "fintech", title: "Fintech — Wharton", desc: "60 min Wharton Fintech videos / readings." },
      { s: "07:15", e: "07:35", type: "commute", title: "Commute to Work", desc: "Bible in a Year podcast.", bible: true },
      { s: "07:40", e: "17:00", type: "work", title: "Work at RTSS", desc: "Operations." },
    ...
    { dow: 4, name: "Thursday — Lower Volume + Mobility", workoutType: "lower-volume", weighIn: false, blocks: [
      { s: "05:15", e: "05:30", type: "wake", title: "Wake & Hydrate", desc: "Water with electrolytes." },
      { s: "05:30", e: "05:50", type: "meal", title: "Light Breakfast", desc: "Greek yogurt or eggs.", meal: "breakfast" },
      { s: "05:50", e: "06:00", type: "prayer", title: "Morning Prayer with Nicole", desc: "10 minutes.", prayer: "morning" },
      { s: "06:00", e: "07:15", type: "fintech", title: "Fintech Heavy Block", desc: "75 min: CFI FTIP modules." },
      { s: "07:15", e: "07:35", type: "commute", title: "Commute to Work", desc: "Bible in a Year podcast.", bible: true },
      { s: "07:40", e: "17:00", type: "work", title: "Work at RTSS", desc: "Operations." },
      { s: "17:00", e: "17:25", type: "commute", title: "Drive to Gym", desc: "Crunch Fitness." },
    ...
    { dow: 5, name: "Friday — Upper Pull + Core (Weigh-in)", workoutType: "upper-pull", weighIn: true, blocks: [
      { s: "05:15", e: "05:30", type: "wake", title: "Weigh-in + Wake", desc: "Step on the scale post-bathroom, pre-coffee. Log it. Then hydrate.", weighIn: true },
      { s: "05:30", e: "05:50", type: "meal", title: "Light Breakfast", desc: "Greek yogurt or eggs.", meal: "breakfast" },
      { s: "05:50", e: "06:00", type: "prayer", title: "Morning Prayer with Nicole", desc: "10 minutes.", prayer: "morning" },
      { s: "06:00", e: "07:15", type: "fintech", title: "Fintech — DataCamp / Applied", desc: "60 min DataCamp AI track or applied project." },
    ...
    { dow: 0, name: "Sunday — Mass + Rest", workoutType: null, weighIn: false, blocks: [
      ...
      { s: "08:30", e: "09:30", type: "flex", title: "Light Reading", desc: "Bible, fintech long-read, or a book." },
